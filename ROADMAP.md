...
>
> **Shipped: T122** — the profile model and discovery (`ClaudeAccount.Discover`, `--profiles`), with the
> picker on the System information page. See [CHANGELOG.md](CHANGELOG.md) Block O.
