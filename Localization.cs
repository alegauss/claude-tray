...
internal static class L
{
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        // Remaining-quota framing of the same four cases (shows quota left instead of used).
        ["stats.proj.atLimit.left"] = "You've run out — 0% left in this window. It resets in {0}; until then, usage is blocked.",
        ["stats.proj.aheadEta.left"] = "At the current pace, your quota runs out in {0} — about {1} before the reset (in {2}). Worth easing off so you don't get blocked.",
        ["stats.proj.ahead.left"] = "You're burning down faster than even pace ({0} left would be expected by now, but you're already down to {1}). It resets in {2}.",
        ["stats.proj.ok.left"] = "You're pacing evenly — still above the even-pace floor of {0}. At the current rate, the quota comfortably lasts until the reset, in {1}.",

        // Chart
        ["stats.chart.noWindow"] = "No limit data for this window.",
        ["stats.chart.projHit"] = "Projected to hit 100% in {0}",
        ["stats.chart.projHitZero"] = "Projected to run out in {0}",
    ...
    private static readonly Dictionary<string, string> PtBr = new()
    {
        ...
        // Enquadramento por cota restante dos mesmos quatro casos (mostra o que resta em vez do usado).
        ["stats.proj.atLimit.left"] = "Você esgotou — 0% restante nesta janela. Ela reseta em {0}; até lá, o uso está bloqueado.",
        ["stats.proj.aheadEta.left"] = "No ritmo atual, sua cota esgota em {0} — cerca de {1} antes do reset (em {2}). Vale desacelerar para não ser bloqueado.",
        ["stats.proj.ahead.left"] = "Você está esgotando mais rápido que o ritmo equilibrado ({0} restante seria o esperado até agora, mas você já está em {1}). Ela reseta em {2}.",
        ["stats.proj.ok.left"] = "Você está no ritmo equilibrado — ainda acima do piso de {0}. No ritmo atual, a cota dura tranquilamente até o reset, em {1}.",

        // Chart
        ["stats.chart.noWindow"] = "Sem dados de limite para esta janela.",
        ["stats.chart.projHit"] = "Projeção de atingir 100% em {0}",
        ["stats.chart.projHitZero"] = "Projeção de esgotar em {0}",
